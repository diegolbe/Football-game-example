...
//     let  b = new Ball(random(400,800,0),random(400,600,0));
//     balls.push(b);
//     console.log(balls);
//
// }
...
// class Ball {
//
// 	constructor(x,y,rotation){ //every ball needs an x value and a y value
// 		    this.x = x;
//     		this.y = y;
...
//       this.y = this.y-5;
//     }
// //   if (this.x >= 553 && this.x <= 554 && this.y > 50 && this.y < 150){
// //     this.y = this.y+5;
// //     this.x = this.x;
// //   }
// // if (this.x >= 646 && this.x <= 647 && this.y > 50 && this.y < 150){
// //         this.y = this.y+5;
// //         this.x = this.x;
//
//     }
...
//
//   if (keyCode === 37){
//     this.x = this.x+this.rotation;
//   this.x = this.x+this.rotation - .10;
//     }
//   if (keyCode === 39){
//     this.x = this.x+this.rotation + .10;
//   }
